...
/* src/game/town/Test.svelte generated by Svelte v3.29.0 */
...
function create_fragment(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["listen"])(button, "click", hello);
				mounted = true;
			}
		},
...
class Test extends svelte_internal__WEBPACK_IMPORTED_MODULE_0__["SvelteComponent"] {
	constructor(options) {
		super();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _game_town_Test_svelte__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./game/town/Test.svelte */ "./src/game/town/Test.svelte");


const classLoader = {
    Test: _game_town_Test_svelte__WEBPACK_IMPORTED_MODULE_0__["default"]
};
window.rusvelte = classLoader;
