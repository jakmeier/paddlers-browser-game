...
use crate::net::{
    game_master_api::GameMasterResponse,
    graphql::{ForceRequest, ScheduledRequest},
    request_foreign_town,
};
use crate::prelude::*;
use crate::{
    game::{
...
use crate::{logging::PaddlersCheck, net::game_master_api::RestApiState};
use paddle::Domain;
...
pub fn load_game_event_manager() {
    ...
    event_manager_activity.private_domained_channel(|_, domain, event: GameEvent| {
        ...
        game.try_handle_event(event).paddlers_check();
    });
}
        ...
        match evt {
            ...
            GameEvent::SendInvitation(foreign_entity) => {
                ...
                let world = self.town_world();
                {
                    ...
                    nuts::publish(ForceRequest::Extra(ScheduledRequest::Visitors, 1));
                }
                self.remove_one_watergate_capacity();
            }
